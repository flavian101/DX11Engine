...
namespace DXEngine {
	...
	std::shared_ptr<Material> MaterialFactory::CreateTexturedNormalMaterial(const std::string& name)
	{
		return std::make_shared<Material>(name, MaterialType::LitNormalMapped);
	}
